...
> models::CreateCategories200Response create_data_custodian_network(create_data_provider_coll_request)
...
> models::DeleteAliases200Response delete_data_custodian_network(id)

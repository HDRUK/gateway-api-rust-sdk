...
> models::CreateDarIntegration201Response create_dar_integration(id, update_dar_integration_request)
...
> models::DeleteApplications200Response delete_dar_integration(id)

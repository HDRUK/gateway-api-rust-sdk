...
pub struct SearchPublications200Response {
    #[serde(rename = "current_page", skip_serializing_if = "Option::is_none")]
    pub current_page: Option<i32>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::SearchPublications200ResponseDataInner>>,
...
impl SearchPublications200Response {
    pub fn new() -> SearchPublications200Response {

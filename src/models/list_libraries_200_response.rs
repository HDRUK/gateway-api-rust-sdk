...
pub struct ListLibraries200Response {
    #[serde(rename = "current_page", skip_serializing_if = "Option::is_none")]
    pub current_page: Option<i32>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::ListLibraries200ResponseDataInner>>,
    ...
    pub links: Option<Vec<models::ListLibraries200ResponseLinksInner>>,
...
impl ListLibraries200Response {
    pub fn new() -> ListLibraries200Response {

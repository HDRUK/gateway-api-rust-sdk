...
pub struct FetchAllCollections200Response {
    #[serde(rename = "message", skip_serializing_if = "Option::is_none")]
    pub message: Option<String>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::Collection>>,
...
impl FetchAllCollections200Response {
    pub fn new() -> FetchAllCollections200Response {

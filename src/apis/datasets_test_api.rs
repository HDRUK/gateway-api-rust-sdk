...
/// Datasets test
pub async fn datasets_test(configuration: &configuration::Configuration, datasets_test_request: models::DatasetsTestRequest) -> Result<models::CreateCategories200Response, Error<DatasetsTestError>> {

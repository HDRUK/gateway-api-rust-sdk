...
pub async fn delete_notifications(configuration: &configuration::Configuration, id: i32) -> Result<models::DeleteApplications200Response, Error<DeleteNotificationsError>> {

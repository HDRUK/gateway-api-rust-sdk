...
/// logout
pub async fn logout(configuration: &configuration::Configuration, ) -> Result<models::DeleteAliases200Response, Error<LogoutError>> {

    let uri_str = format!("{}/api/v1/logout", configuration.base_path);
